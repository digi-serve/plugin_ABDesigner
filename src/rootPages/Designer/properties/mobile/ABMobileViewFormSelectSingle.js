...
export default function (AB) {
   const BASE_ID = "properties_abmobileview_form_select_single";

   const ABMobileViewFormItem = FABMobileViewFormItem(AB);
   const L = ABMobileViewFormItem.L();

   class ABMobileViewFormSelectSingleProperty extends ABMobileViewFormItem {
      constructor() {
         super(BASE_ID, {
            // Put our ids here
            type: "",
   ...
   return ABMobileViewFormSelectSingleProperty;
}
