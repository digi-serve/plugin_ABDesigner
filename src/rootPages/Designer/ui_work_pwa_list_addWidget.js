/*
 * ui_work_pwa_list_addWidget.js
 *
 * Display the menu for creating a new Widget on a PWA.
 *
 */
import UI_Class from "./ui_class";

export default function (AB) {
   const ibase = "ui_work_pwa_list_addWidget";
   // const uiConfig = AB.Config.uiSettings();
   const UIClass = UI_Class(AB);
   const L = UIClass.L();

   class UI_Work_PWA_List_AddWidget extends UIClass {
      constructor() {
         super(ibase, {
            popup: "",
            list: "",
   ...
   return new UI_Work_PWA_List_AddWidget();
}
